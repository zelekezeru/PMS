...
class TaskController extends Controller
{
    ...
    public function store(TaskStoreRequest $request)
    {
         ...
         * 
         * sets the assigned users ($users) to the logged in user if the role is employee or sets it to what the logged in user assigned if the role is otherwise
         */
    ...
    public function edit(Task $task)
    {
        ...
        $forToday = $isDaily ? $task->days()->first() : null;
