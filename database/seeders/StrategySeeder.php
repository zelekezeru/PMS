...
class StrategySeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('strategies')->insert([
            ...
            ['name' => '4. Acquire and retain adequate qualified personnel and up-to-date technology and key facilities.','pillar_name' => 'Pillar 3: Finance',  'description' => 'Description for Strategy 4'],
